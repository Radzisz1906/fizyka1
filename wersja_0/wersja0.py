...
def kolizja(j, atomy):  # zwraca indeks pierwszego atomu z którym wykryje zdarzenie
    ...
    for i in range(len(atomy)):
        ...
        if 56 < math.sqrt((atom.Rect.centerx - atom2.Rect.centerx)**2 + (atom.Rect.centery - atom2.Rect.centery)**2) <= 60 + 3:
            print("kolizja")
            return i
...
obiekt8 = pygame.Rect(0, 0, s, s)
atom8 = Atom(obiekt8, 0, 0, s, (100, 100, 250))
atomy.append(atom8)'''
